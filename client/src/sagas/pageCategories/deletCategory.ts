...
export function* deletCategory(action: { payload: { _id: string; callback: () => void } }) {
    try {
...
export const deletCategorySuccess = (data: { _id: string; message: string }) => {
    return {
...
export const deletCategoryFail = (e: { response: { data: { message: string } } }) => {
    return {
