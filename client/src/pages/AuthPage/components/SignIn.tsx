...
const AuthForm: React.FC<AuthFormProps> = ({ signIn, userIsLogining }: AuthFormProps): React.ReactElement => {
    const initialValues: InitialValues = {
        email: "",
        password: "",
    };

    const handleSubmit = (data: InitialValues): void => {
        signIn(data);
    };
            ...
            {({ errors }) => (
                <Form className="auth__form form">
                    ...
                    <div className="form__submit">
                        <Button variant="contained" color="primary" fullWidth type="submit" disabled={userIsLogining}>
                            Войти
                        </Button>
                    </div>
